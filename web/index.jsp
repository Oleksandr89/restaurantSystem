...
<head>
    ...
    <title>project.models.Login</title>
    <meta charset="utf-8">
            ...
            <div id="bg_top">
                <div id="menu">
                    <ul>
                        ...
                        <li><b><a href="index.jsp"><strong>Order Online</strong></a></b></li>
                        <li><b><a href="Registerform.jsp" s><strong>Register</strong></a></b></li>
        ...
        <center>
            <div id="section">
                <li class="animated wow fadeInDown">
                    <h4><input type="text" name="nm" placeholder="Email id or Username"
                               style="width: 180px; padding: 6px;"></h4></br>
                    <h4><input type="password" name="pw" placeholder="Password" style="width: 180px; padding: 6px;">
                    </h4></br>
